...
describe('acm base client should success', function () {
  ...
  it('get signature', async function () {
    expect(typeof await client.__get_signature({ query: { k1: 'v1', k2: 'v1' }, headers: {} })).to.be('string');
    expect(typeof await client.__get_signature({ body: { k1: 'v1', k2: 'v2' }, headers: {} }, 'encode')).to.be('string');
    expect(typeof await client.__get_signature({ body: { k1: 'v1', k2: 'v3' }, headers: {} }, 'form')).to.be('string');
    expect(typeof await client.__get_signature({ query: { group: 'g1' }, headers: {} })).to.be('string');
    expect(typeof await client.__get_signature({ query: { group: 'g1', tenant: 't1' }, headers: {} })).to.be('string');
  });
